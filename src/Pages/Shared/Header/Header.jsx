...
const Header = () => {
    ...
    return (
        <header className="bg-theme-secondary pt-[58px] pb-5">
            <div className="px-4 mx-auto container h-[48px]">
                            ...
                            menuItems.map(item => (
                                <li key={item.path}>
                                    <NavLink
                                        ...
                                        className={({ isActive }) =>
                                            isActive
                                            ? 'text-sm font-poppins font-semibold tracking-wide text-[#474747]'
                                            : 'text-sm font-poppins font-normal tracking-wide text-[#474747]'
                                        }
                                    >
                                        { item.title }
                                    </NavLink>
